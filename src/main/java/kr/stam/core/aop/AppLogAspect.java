...
public class AppLogAspect {
     ...
     *
     * kr.stam.core.app.main.service하위 *Service의 모든 메서드
     * 모든 메소드 시작전, 종료후 log를 write 한다.
     */
    @Around("execution(* kr.stam.core.app.main.service.*Service.*(..))")
     ...
     *
     * kr.stam.core.app.main.controller하위 *Controller의 모든 메서드
     * 모든 메소드 시작전, 종료후 log를 write 한다.
     */
    @Around("execution(* kr.stam.app.main.controller.*Controller.*(..))")
